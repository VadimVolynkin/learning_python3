...
# ФУНКЦИИ
# ================================================================================================================
# функция - объект, который можно присвоить переменной без вызова: bar=foo. Вызвать можно так: bar().
# параметры функции - локальные переменные, которым присваиваются значения(аргументы) в моент вызова
# значения по умолчанию вычисляются 1 раз в точке выполнения инструкции def
# использование списков и словарей по умолчанию необходимо избегать - они используются всеми вызовами.
