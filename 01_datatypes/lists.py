...
# TODO need check Если объекты мутабельны, то изменение в 1 списке изменит второй список.
...
newlist = copy.deepcopy(mylist)   создаст новый объект списка с новыми объектами
