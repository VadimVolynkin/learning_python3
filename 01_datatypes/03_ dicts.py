...
# Ordered dict до Питона 3.7 неупорядоченные наборы пар ключ-значение (номеров позиций в словарях нет), порядок добавления не важен.
...
# ORDERED DICTS
# ======================================================================================================
# Такой дикт содержит упорядоченные пары ключ-значение. Важен порядок добавления - два словаря с одинаковыми значениями , но разным порядком будут не равны.
# Пары можно вызывать по индексу.
